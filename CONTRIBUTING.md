...
| --- | --- | --- |
| Root README chooser or docs route map | `just guard-docs` | Root onboarding links, README CLI command families, command-hint extraction, `easycat docs`, and JSON route entries |
