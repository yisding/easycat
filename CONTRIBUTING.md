...
| Guard scaffold docs | `just guard-templates` | `uv run pytest tests/cli/test_templates.py tests/cli/test_init.py::test_list_templates tests/cli/test_init.py::test_list_templates_json tests/cli/test_init.py::test_init_list_templates_json_catalog_includes_next_step_commands` |
...
| Scaffold templates or template catalog | `just guard-templates` | Generated README sections, line budgets, catalog text, catalog JSON, and catalog next-step commands |
