...
from easycat.validation.provider_reports import _default_model_api_version
...
PROVIDER_SURFACE_CONTRACTS: tuple[ProviderSurfaceContract, ...] = (
    ProviderSurfaceContract(
        ...
        protocol="http",
        mode="batch",
        model_api_version=_default_model_api_version("stt", "openai"),
    ...
    ProviderSurfaceContract(
        ...
        protocol="websocket",
        mode="realtime",
        model_api_version=_default_model_api_version("stt", "openai-realtime"),
        required_extra="openai",
        credential_env_var="OPENAI_API_KEY",
        contract_path="tests/contracts/test_stt_provider_contracts.py",
    ...
    ProviderSurfaceContract(
        ...
        protocol="websocket",
        mode="realtime",
        model_api_version=_default_model_api_version("stt", "deepgram"),
    ...
    ProviderSurfaceContract(
        ...
        mode="batch+realtime",
        model_api_version=_default_model_api_version("stt", "elevenlabs"),
    ...
    ProviderSurfaceContract(
        ...
        protocol="websocket",
        mode="realtime",
        model_api_version=_default_model_api_version("stt", "cartesia"),
    ...
    ProviderSurfaceContract(
        ...
        protocol="http",
        mode="streaming",
        model_api_version=_default_model_api_version("tts", "openai"),
        required_extra="openai",
        credential_env_var="OPENAI_API_KEY",
    ...
    ProviderSurfaceContract(
        ...
        protocol="websocket",
        mode="streaming",
        model_api_version=_default_model_api_version("tts", "deepgram"),
        required_extra="deepgram",
        credential_env_var="DEEPGRAM_API_KEY",
        contract_path="tests/contracts/test_tts_provider_contracts.py",
    ...
    ProviderSurfaceContract(
        ...
        protocol="http/websocket",
        mode="streaming",
        model_api_version=_default_model_api_version("tts", "elevenlabs"),
        required_extra="elevenlabs",
        credential_env_var="ELEVENLABS_API_KEY",
        contract_path="tests/contracts/test_tts_provider_contracts.py",
    ...
    ProviderSurfaceContract(
        ...
        protocol="websocket",
        mode="streaming",
        model_api_version=_default_model_api_version("tts", "cartesia"),
        required_extra="cartesia",
        credential_env_var="CARTESIA_API_KEY",
        contract_path="tests/contracts/test_tts_provider_contracts.py",
    ...
    ProviderSurfaceContract(
        ...
        protocol="python-onnx",
        mode="streaming",
        model_api_version="funasr-fsmn-vad-bundled",
    ...
    ProviderSurfaceContract(
        provider="telnyx",
        surface="transport",
        adapter="easycat.transports.telnyx_media.TelnyxTransport",
        protocol="telnyx-media-streams",
        mode="duplex",
        model_api_version="telnyx-media-streams-v1",
        required_extra="telnyx",
        credential_env_var="TELNYX_STREAM_URL",
        contract_path="tests/contracts/test_transport_contracts.py",
        cassette_path="tests/cassettes/transport/telnyx.json",
        cassette_status="deferred",
        live_canary_status="deferred",
    ),
    ProviderSurfaceContract(
