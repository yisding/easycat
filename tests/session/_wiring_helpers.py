...
def make_wiring(
    *,
    ...
    fence_session_actions: Callable[[str], Awaitable[None]] | None = None,
    ...
    cut_off_tts_for_text_replacement: Callable[[], Awaitable[None]] | None = None,
    ...
    return SessionWiringContext(
        ...
        fence_session_actions=fence_session_actions or _noop_async,
        ...
        cut_off_tts_for_text_replacement=cut_off_tts_for_text_replacement or _noop_async,
