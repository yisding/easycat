...
> objects, which means loading a hostile `.bundle` can execute
> arbitrary code. Only open bundles you generated yourself or got
> from a source you trust. (The ones checked in under `bundles/`
> are generated by the companion scripts in this repo.)
