...
4. **The 2×3 matrix.** Run all six combinations on the same
   ...
   `../../peripherals/peripheral-observability-and-cost.md` for the planned surface.
...
6. **A decision matrix.** Latency / offline / quality /
   ...
   the cost surface in `../../peripherals/peripheral-observability-and-cost.md`
   lands.
...
- `../../peripherals/peripheral-cli.md` — the CLI surface
- `../../peripherals/peripheral-deployment.md` — production hosting and ops
- `../../peripherals/peripheral-provider-ecosystem.md` — adding a new provider
- `../../peripherals/peripheral-langchain-langgraph-bridge.md` — richer agent
  bridges
- `../../peripherals/peripheral-eval-and-debugger-ui.md` — what chapter 12
  prototypes, productionised
- `../../peripherals/peripheral-redaction.md` — what to keep out of journals
- `../../peripherals/peripheral-observability-and-cost.md` — cost-per-turn and
