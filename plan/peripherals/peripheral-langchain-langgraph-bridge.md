...
> `_langchain_events.py` translator, auto-adapt dispatch, examples, and
> tests. Keep this document as the historical bridge design and review
> reference; many sections below intentionally read like a pre-implementation
> plan.
>
> **Originally not part of:**
>
> - `../roadmap/essential-debug-first-runtime.md` (essential plan)
> - `../workstreams/workstream-1-journal-foundation.md` through
>   `../workstreams/workstream-5-legacy-removal.md`
