...
| [peripheral-dx-onboarding.md](peripheral-dx-onboarding.md) | Partially landed | `run`, string-keyed providers, config presets, error codes, `record_to`, log-level env support, and canonical example line budgets exist; `EasyConfig` remains at 22 top-level fields and meets the ≤22 flattening target. |
