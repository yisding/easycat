...
| [peripheral-dx-onboarding.md](peripheral-dx-onboarding.md) | Partially landed | `run`, string-keyed providers, config presets, error codes, `record_to`, log-level env support, and canonical example line budgets exist; `EasyConfig` remains at 24 top-level fields against the ≤22 flattening target. |
