...
- Provider subpackages `stt/`, `tts/`, `vad/`, `transports/`, `telephony/` — one provider per file; agent bridges in `integrations/agents/` behind the `ExternalAgentBridge` protocol.
