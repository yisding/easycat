...
just guard-docs                  # Guard root onboarding docs, README command hints, and docs route map
...
uv run pytest tests/cli/test_templates.py tests/cli/test_init.py::test_list_templates tests/cli/test_init.py::test_list_templates_json tests/cli/test_init.py::test_init_list_templates_json_catalog_includes_next_step_commands  # Raw fallback for just guard-templates
