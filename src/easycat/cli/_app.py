...
_DOCS_ONBOARDING_RAW_GUARD_COMMANDS: tuple[str, ...] = (
    (
        ...
        "tests/test_quickstart_e2e.py::"
        "test_readme_cli_section_lists_registered_top_level_commands "
        "tests/test_quickstart_e2e.py::"
        "test_readme_cli_section_does_not_advertise_stale_bundle_commands "
        "tests/test_quickstart_e2e.py::"
        "test_readme_cli_section_does_not_advertise_stale_top_level_commands "
        "tests/test_command_hints.py "
        "tests/test_install_guidance.py::test_readme_cli_explain_examples_are_copyable "
        "tests/test_install_guidance.py::test_readme_cli_command_examples_are_locally_valid "
        "tests/test_install_guidance.py::test_readme_json_guidance_covers_schema_"
        "command_families "
        "tests/test_install_guidance.py::test_readme_cli_debug_json_examples_are_copyable "
        "tests/test_install_guidance.py::test_readme_cli_validate_examples_are_copyable "
    ...
    (
        ...
        "tests/cli/test_init.py::test_init_list_templates_json_"
        "catalog_includes_next_step_commands "
        "tests/cli/test_init.py::test_init_next_steps_match_template_readme_run_command "
        "tests/cli/test_init.py::test_init_next_steps_match_template_readme_check_command "
        "tests/cli/test_init.py::test_init_json_next_step_commands_match_template_readme"
    ),
    (
        "uv run pytest "
