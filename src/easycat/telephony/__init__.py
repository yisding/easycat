...
_LAZY_ATTR: dict[str, str] = {
    ...
    "OptOutDetectionResult": "easycat.telephony.compliance",
    "OptOutIntentClassifier": "easycat.telephony.compliance",
    "OpenAIOptOutIntentClassifier": "easycat.telephony.compliance",
    "classify_opt_out": "easycat.telephony.compliance",
...
if TYPE_CHECKING:
    from easycat.telephony.compliance import (
        ...
        CallBlocked,
        DNCList,
        OpenAIOptOutIntentClassifier,
        OptOutDetectionResult,
        OptOutIntentClassifier,
        check_calling_hours,
        classify_opt_out,
        detect_opt_out,
        lookup_timezone,
