...
# Guard root onboarding docs, install guidance, docs routes, and docs CLI JSON.
guard-docs:
...
# Guard scaffold templates, init flows, schema rejection paths, and catalog output.
guard-templates:
